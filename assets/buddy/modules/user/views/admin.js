...
(function (window, document) {
  ...
  window.BuddyUserViews.admin = function (context) {
    ...
    [['firstName','Nombre'],['lastName','Apellido'],['name','Nombre para mostrar'],['email','Correo electrónico'],['phone','Teléfono'],['locale','Idioma']].forEach(function(item){var label=document.createElement('label');label.textContent=item[1];var input=document.createElement('input');input.name=item[0];input.value=user[item[0]]||'';label.appendChild(input);form.appendChild(label);});
